...
<head>
    ...
    <title>Benvenuto tra gli Avengers</title>
    <link rel="stylesheet" href="CSS/nav-style.css">
    <link rel="stylesheet" href="CSS/categories-style.css">
    <link rel="stylesheet", href="CSS/create-success-style.css">
...
<div class="scritte">
    <h2>Benvenuto tra gli Avengers!</h2>
    <h3>Il tuo impegno sara di fondamentale importanza per salvare il mondo</h3>
